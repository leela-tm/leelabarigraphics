...
int main(int argc, char* argv[]) {
    ...
    backgroundTextures.push_back(loadTexture("./assets/pixelforest/snowsky.jpg"));
    backgroundTextures.push_back(loadTexture("./assets/pixelforest/snowground.png"));
    backgroundTextures.push_back(loadTexture("./assets/pixelforest/cottage.png"));
